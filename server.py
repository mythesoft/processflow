...
import processflow.config as config
from flask_user import login_required, UserManager, UserMixin, SQLAlchemyAdapter
from datetime import datetime
from processflow.models import db, User
import os
import os.path
import processflow.core as core
import uuid
import processflow.common as common
import json
from datetime import datetime
import sys
...
def get_init_session_data():
    data = {}
    data['modules_infos'] = {'core': {'main': core, 'path': 'processflow'}}
    return data
