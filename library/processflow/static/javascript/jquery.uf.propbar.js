define(['app', 'processflow'], function( app, processflow ) {
  $.widget( "processflow.uf_propbar", {
    options: {
      labels: {
    ...
    _create: function() {
      ...
      app.onEvent('processflow::operator_select', function(e, operatorId) {
        self.displayOperatorParameters(operatorId);
      });
      
      app.onEvent('processflow::operator_unselect', function(e) {
      ...
      app.onEvent('processflow::link_select', function(e, linkId) {
        self.displayLinkParameters(linkId);
      });
      
      app.onEvent('processflow::link_unselect', function(e) {
        if (self.linkId != null) {
          self.els.content.empty();
          self.els.nothing.show();
          self.linkId = null;
    ...
    displayLinkParameters: function(linkId) {
      ...
      var processData = processflow.getOpenedProcessData();
      ...
      $colorInput.val(processflow.ui.flowchart.flowchartMethod('getLinkMainColor', linkId));
      ...
      $deleteButton.click(function() {
        app.triggerEvent('processflow::delete_selected');
      });
      
      $colorInput.change(function() {
        processflow.ui.flowchart.els.flowchart.flowchart('setLinkMainColor', linkId, $colorInput.val());
      });
    ...
    displayOperatorParameters: function(operatorId) {
      ...
      var operatorProperties = processflow.ui.flowchart.flowchartMethod('getOperatorFullProperties', operatorData);
      var operatorTypeData = processflow.getOperatorInfos(operatorType);
      ...
      $titleInput.val(processflow.ui.flowchart.flowchartMethod('getOperatorTitle', operatorId));
      ...
      $titleInput.keyup(function() {
        processflow.ui.flowchart.els.flowchart.flowchart('setOperatorTitle', operatorId, $titleInput.val());
      });
    ...
    fillPropertyContent: function(operatorId, propKey, propInfos, $divs) {
      var self = this;
      var processData = processflow.getOpenedProcessData().process;
      ...
      processflow.loadFieldType(propInfos.type, function(module) {
    ...
    regenerateParameters: function() {
      if (this.operatorId != null) {
        ...
        app.triggerEvent('processflow::process_change_detected');
      }
    },
