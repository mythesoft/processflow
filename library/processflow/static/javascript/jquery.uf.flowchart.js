define([
    'app',
    'processflow',
    'processflow-lib-mousewheel',
    'processflow-lib-panzoom',
    'processflow-lib-flowchart'], function( app, processflow ) {
    $.widget( "processflow.uf_flowchart", {
        options: {
        ...
        _create: function() {
            ...
            options.onOperatorSelect = function(operatorId) {
                app.triggerEvent('processflow::operator_select', operatorId);
                return true;
            }
            options.onOperatorUnselect = function() {
                app.triggerEvent('processflow::operator_unselect');
                return true;
            }
            options.onLinkSelect = function(linkId) {
                app.triggerEvent('processflow::link_select', linkId);
                return true;
            }
            options.onLinkUnselect = function() {
                app.triggerEvent('processflow::link_unselect');
                return true;
            }
            ...
            app.onEvent('processflow::process_open', function(e, processData) {
                self.setData(processData.process);
            });

            app.onEvent('processflow::delete_selected', function() {
                self.els.flowchart.flowchart('deleteSelected');
            });
        ...
        setData: function(originalData) {
            ...
            processflow.getOperators(function(operators) {
        ...
        changeDetected: function() {
            ...
            var currentProcessData = processflow.getOpenedProcessData();
