define(['app'], function( app ) {
  $.widget( "processflow.uf_process_main_infos", {
    options: {
    },
    els: {
      title: null,
    ...
    _create: function() {
      ...
      var self = this;
      app.onEvent('processflow::process_open', function(e, operatorData) {
      ...
      app.onEvent('processflow::process_saved', function(e, success) {
        if (success) {
